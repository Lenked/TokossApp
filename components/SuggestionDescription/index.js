...
const SuggestionDescription = ({ title, subDescription, description, showBtn }) => {
  return (
    <View style={{display: 'flex', flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-around'}}>
      ...
      <View>
        ...
        <Text style={[styles.title, {fontSize: 16, marginTop: 20}]}>{"Motif de la suggestion"}</Text>
        <Text style={[styles.description, {paddingTop: 5}]}>{description}</Text>
        {
          showBtn ? (
