    ...
    <View style={styles.verticalContainer}>
      ...
      <View style={styles.verticalContainer}>
        <View style={[styles.rowElement, {marginVertical: 20}]}>
          <MaterialCommunityIcons name="bell" size={35} color="#08B3C3" />
          <Text style={{fontSize: 25, color: '#08B3C3', fontWeight: 'bold', paddingHorizontal: 10}}>Notification</Text>
        </View>
...
export default NotificationListWithDel;